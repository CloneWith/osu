...
namespace osu.Game.Online.API.Requests
{
    public class GetBeatmapAttributesRequest : APIRequest<APIBeatmapDifficultyAttributesResponse>
    {
        ...
        public GetBeatmapAttributesRequest(int beatmapId, int modBits, string? ruleset = null)
            : this(beatmapId, modBits.ToString(), ruleset)
        {
        }

        public GetBeatmapAttributesRequest(int beatmapId, LegacyMods modBits, string? ruleset = null)
            : this(beatmapId, (int)modBits, ruleset)
        {
        }
