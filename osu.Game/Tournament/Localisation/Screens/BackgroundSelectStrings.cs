...
{
    public static class BackgroundSelectStrings
    {
        ...
        /// </summary>
        public static LocalisableString DialogCancel => new TranslatableString(getKey(@"dialog_cancel"), @"No, just stay the same.");
