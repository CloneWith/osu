...
{
    public class ShowcaseBeatmap : IBeatmapInfo, IBeatmapSetOnlineInfo
    {
        ...
        public ShowcaseBeatmap(APIBeatmap beatmap)
        {
        ...
        public bool Equals(IBeatmapInfo? other) => other is ShowcaseBeatmap b && this.MatchesOnlineID(b);
